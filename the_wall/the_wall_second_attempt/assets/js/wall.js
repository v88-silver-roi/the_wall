...
postMessage = (event) => {
    ...
    const cancel_message_button = message_clone.querySelector(".cancel_edit_message");
    ...
    postComment = (event) => {
        ...
        const cancel_comment_button = message_clone.querySelector(".cancel_edit_comment");
